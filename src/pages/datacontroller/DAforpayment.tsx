import '../Styles/DAforpayment.css';
...
interface WorkPermit {
  ...
  const DataControllerForPayment: React.FC = () => {
  ...
  const handleClassificationChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const fetchWorkPermits = async () => {
      try {
        const response = await fetch('http://localhost:3000/getworkpermitsforpayments', {
          method: 'GET',
          headers: {
  ...
  export default DataControllerForPayment;